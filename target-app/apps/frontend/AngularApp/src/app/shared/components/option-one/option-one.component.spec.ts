...
describe('OptionOneComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(OptionOneComponent);
    

    ({fixture, cpnt} =  grabComponentInstance(OptionOneComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('OptionOneView')
    })
